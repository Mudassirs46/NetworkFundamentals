...
* The most commonly used WAN Data-Link Layer \[\[202011201526 Data-Link Layer\]\] protocol is Ethernet & WAN Data-Link Layer protocols are High-Level Data Link Control \(**HDLC**\) and Point-to-Point Protocol \(**PPP**\). 
